                                ...
                                <div class="table-wrapper">
                                    <table class="alt">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Item30</td>
                                                <td>async, await & fetch()</td>
                                            </tr>
                                            <tr>
                                                <td>Item31</td>
                                                <td>onClick, onChange & stringify()</td>
                                            </tr>
                                            <tr>
                                                <td>Item32</td>
